...
impl<'q,'a,'c,X> FuncContext<'q,'a,'c,X> { //,'b //,'b
    ...
    // pub fn set_func_call<I:AsRef<[Value]>>(&mut self,value:&Value,params : I) {
    //     // self.machine.call_value(value, params)
    // }

    // pub fn set_method_call<I:AsRef<[Value]>>(&mut self,name:&str,params : I) {
    //     // println!("===========x");
...
pub struct FuncContext2<'q,'a,'c> { //,'b
    machine:&'q mut dyn MachineTrait<'a,'c>, //,'b
    params_start : usize,
    params_num : usize,
...
impl<'q,'a,'c> FuncContext2<'q,'a,'c> { //,'b //,'b
    pub fn new(machine:&'q mut dyn MachineTrait<'a,'c>,params_num : usize,) -> Self { //,'b
        let stack_len = machine.stack().len();
