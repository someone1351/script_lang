...
use super::super::super::texpr_compiler::cmds::get_idn;
...
pub fn goto_cmd<'a>(record : RecordContainer<'a>, builder :&mut Builder<'a,PrimitiveContainer<'a>,BuilderErrorType>) -> Result<(),BuilderError<BuilderErrorType>> {
    ...
    builder.goto(JmpCond::None,label);
