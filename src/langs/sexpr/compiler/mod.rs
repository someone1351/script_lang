...
use crate::compiler::builder::{Builder, BuilderError};
use crate::sexpr::parser;
use cmds::*;

use crate::StringVal;

use crate::build::*;
use super::parser::{SExprContainer, SExprValContainer};
use crate::compiler::*;
...
pub enum CompileErrorType {
    ...
    SexprParser(parser::ParserErrorType),
...
impl Compiler {
    ...
    pub fn compile(&self,src : &str, version:usize, path : Option<&Path>, keep_src : bool, print_ast:bool) -> Result<BuildT,CompileError> {
        ...
        match parser::parse(src.as_str(), false, path) {
            Ok(sexpr_tree)=> {
